...
import me.andannn.aniflow.data.internal.mapper.mediaType
import me.andannn.aniflow.data.internal.mapper.toDomain
import me.andannn.aniflow.data.internal.mapper.toDomainWithFlattenMapper
import me.andannn.aniflow.data.internal.mapper.toEntity
import me.andannn.aniflow.data.internal.mapper.toRelation
import me.andannn.aniflow.data.internal.mapper.toRelationDomain
import me.andannn.aniflow.data.internal.mapper.toServiceType
...
import me.andannn.aniflow.domain.impl.common.toError
...
internal fun Iterable<MediaWithMediaListItem>.sorted(sort: MediaListSort) =
    when (sort) {
...
context(service: AniListService, database: MediaLibraryDao)
private fun MediaCategory.syncLocalWithService(scope: CoroutineScope): Deferred<AppError?> =
    scope.async {
